...
Component({
  ...
  methods: {
    updateStyle() {
      const zIndex = Number.isFinite(this.data.zIndex) ? this.data.zIndex : 1e3;
    ...
    handleTap(event) {
      var _a, _b;
      if (event && ((_b = (_a = event.target) == null ? void 0 : _a.dataset) == null ? void 0 : _b.mpOverlay) !== "root") return;
