...
Component({
  ...
  methods: {
    ...
    clearTimer() {
      if (this._timer !== void 0) clearTimeout(this._timer);
      this._timer = void 0;
    },
    ...
    update(now = Date.now()) {
      const remaining = this._deadline === void 0 ? this._remaining : Math.max(0, this._deadline - now);
